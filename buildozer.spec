...
title = Markov Comic Generator

# (str) Package name
package.name = markovcomicgenerator
...
source.include_exts = py,png,kv,ttf,txt,tsv
...
requirements = six,kivy,pil,pygame
...
p4a.local_recipes = /home/james/Programming/Markov-Comic-Generator/.buildozer/android/platform/python-for-android-master/pythonforandroid/recipes
